...
namespace Auth0\Lumen\Repository;

use Auth0\Lumen\Auth0User;
use Auth0\Lumen\Auth0JWTUser;
use Auth0\Lumen\Contract\Auth0UserRepository as Auth0UserRepositoryContract;
